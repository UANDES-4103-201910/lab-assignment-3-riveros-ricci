...
Category.create(name: "platea baja", venue: Venue.where(name: "Estadio nacional"))
Category.create(name: "platea alta", venue: Venue.where(name: "Estadio nacional"))
Category.create(name: "platea media", venue: Venue.where(name: "Estadio nacional"))
Category.create(name: "cancha A", venue: Venue.where(name: "Movistar Arena"))
Category.create(name: "cancha B", venue: Venue.where(name: "Movistar Arena"))
Category.create(name: "cancha C", venue: Venue.where(name: "Movistar Arena"))

Event.create(name: "Police en el nacional", description: "ascdosacasmcsaomcasocma adsdasd sadas", start_date: DateTime.now, venue: Venue.where(name: "Estadio nacional"))
Event.create(name: "Guns en el nacional", description: "asdasd adsdasd sadas", start_date: DateTime.now, venue: Venue.where(name: "Estadio nacional"))
Event.create(name: "The Doors en el movistar", description: "ascdosacalfdfgdflsmcsaomcasocma adsdasd sadas", start_date: DateTime.now, venue: Venue.where(name: "Movistar Arena"))
Event.create(name: "Hannah Montana en el movistar", description: "asdasdsad adsdasd sadas", start_date: DateTime.now, venue: Venue.where(name: "Movistar Arena"))

Order.create(user: User.find(1), total_paid: 1000)
Ticket.create(event: Event.find(1), price: 1000, category: Category.find(1), order: Order.find(1))
Order.create(user: User.find(1), total_paid: 1000)
Ticket.create(event: Event.find(2), price: 1000, category: Category.find(2), order: Order.find(2))
Order.create(user: User.find(1), total_paid: 1000)
Ticket.create(event: Event.find(3), price: 1000, category: Category.find(4), order: Order.find(3))
